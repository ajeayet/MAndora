                ...
                <div class="mt-7 scroll scroll-pull ps ps--active-y" style="height: 428px; overflow: hidden;">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        ...
                        <div class="symbol symbol-circle symbol-50 mr-3">
                            ...
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">JmV</a>
                                <span class="text-muted font-weight-bold font-size-sm">Super admin</span>
                            </div>
                        </div>

                        <div class="d-flex flex-column align-items-end">
                            <span class="text-muted font-weight-bold font-size-sm">1 min</span>
                        </div>
                    </div>
                    <!--end:User-->
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Mababi</a>
                                <span class="text-muted font-weight-bold font-size-sm">Admin</span>
                            </div>
                        </div>
                        <div class="d-flex flex-column align-items-end">
                            <span class="text-muted font-weight-bold font-size-sm">2 hrs</span>
                            <span class="label label-sm label-success">17</span>
                        </div>
                    </div>
                    <!--end:User-->
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Lauro</a>
                                <span class="text-muted font-weight-bold font-size-sm">Tweettweeeet</span>
                            </div>
                        </div>

                        <div class="d-flex flex-column align-items-end">
                            <span class="text-muted font-weight-bold font-size-sm">9 hrs</span>
                            <span class="label label-sm label-danger">27</span>
                        </div>
                    </div>
                    <!--end:User-->
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">Viray</a>
                                <span class="text-muted font-weight-bold font-size-sm">love</span>
                                <span class="text-dark-55 text-hover-primaryfont-weight-bold font-size-sm">charge</span>
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <span class="label label-sm label-danger">7</span>
                        </div>
                    </div>
                    <!--end:User-->
...
<!--end::Navigation-->
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-dark-75 font-weight-bold font-size-h5">JmV</div>
                    <div>
